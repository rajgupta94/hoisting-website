  ...
  return (
    <section className="w-full py-24 px-4 sm:px-8 relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="text-center mb-20 lg:mb-24 text-reveal">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6">
            Get Your Website Live Today
          </h2>
          <p className="text-secondary opacity-70 text-[15px] max-w-3xl mx-auto leading-relaxed font-light">
        ...
        <div className="relative max-w-5xl mx-auto lg:px-10">
          ...
          {/* Steps Grid */}
          <div className="flex flex-col md:flex-row justify-between items-start gap-16 md:gap-8 relative z-10">
            {steps.map((step, index) => (
              <div key={index} className="flex flex-col items-center gap-6 group flex-1">
